...
| R-08 | **Incompatibilité de versions** React 19 / R3F / drei au moment de l'installation. | 2 | 2 | 4 | ✅ **Levé le 2026-08-20 (P5-01)** — matrice vérifiée par exécution (installation, types sous TS 6.0.3, scène réellement montée sans WebGL) : `three@0.185.1`, `@react-three/fiber@9.7.0`, `@react-three/drei@10.7.8`. ⚠️ **Plafond latent** : R3F exige `react >=19 <19.3` ; nous sommes en 19.2.8, dernière publiée — dès P5-02, monter en 19.3 devient un choix contre R3F. Versions figées au `package.json` et au lockfile. | 5 |
